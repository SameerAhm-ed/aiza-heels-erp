...
export function Sidebar({ mobileOpen = false, onMobileClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "sticky top-0 hidden md:flex flex-col border-r bg-sidebar text-sidebar-foreground transition-all duration-300 ease-in-out z-20 h-screen shrink-0",
          collapsed ? "w-16" : "w-64"
        )}
      >
      ...
      >
        ...
        <aside
          className={cn(
            "absolute left-0 top-0 h-full w-72 max-w-[85vw] flex flex-col bg-sidebar text-sidebar-foreground shadow-xl transition-transform duration-300 ease-in-out",
