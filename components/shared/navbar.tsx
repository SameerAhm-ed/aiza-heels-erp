...
import { Sun, Moon, Plus, Calendar, Menu } from "lucide-react";
...
export function Navbar({ onMenuClick }: { onMenuClick?: () => void }) {
  ...
  return (
    <header className="sticky top-0 z-10 flex h-16 items-center justify-between gap-2 border-b bg-card/80 px-3 sm:px-6 backdrop-blur-md">
      {/* Status indicator */}
      <div className="flex items-center gap-2 sm:gap-4 min-w-0">
        ...
        <div className="hidden sm:flex items-center gap-2 text-xs text-muted-foreground bg-muted/60 px-3 py-1.5 rounded-full border border-border/50">
